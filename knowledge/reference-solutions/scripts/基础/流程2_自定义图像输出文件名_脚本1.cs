...
public partial class UserScript:ScriptMethods,IProcessMethods
{
    ...
    public bool Process()
    {
		...
		string strSolPath = VmSolution.Instance.SolutionPath;
        string folderName = System.IO.Path.GetDirectoryName(strSolPath);
        string strPath = folderName + "\\" + BarCode;
        
        this.CurrentProcess.GetModule("输出图像1").SetValue("OriginImgPath",strPath);
        
        this.CurrentProcess.GetModule("输出图像1").SetValue("RenderImgPath",strPath+"_Render");
