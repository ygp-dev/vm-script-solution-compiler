...
const Operation = Type.Object({
  ...
  pathInput: Type.Optional(Type.String({ description: "dxfRender: declared string input containing the DXF path." })),
  widthInput: Type.Optional(Type.String({ description: "dxfRender: declared int input; its default must be 1920." })),
  heightInput: Type.Optional(Type.String({ description: "dxfRender: declared int input; its default must be 1080." })),
  imageOutput: Type.Optional(Type.String({ description: "dxfRender: declared image output." })),
  successOutput: Type.Optional(Type.String({ description: "dxfRender: declared bool success output." })),
  errorOutput: Type.Optional(Type.String({ description: "dxfRender: declared string structured failure output." })),
  entityCountOutput: Type.Optional(Type.String({ description: "dxfRender: declared int source entity count output." })),
  renderedCountOutput: Type.Optional(Type.String({ description: "dxfRender: declared int rendered entity count output." })),
